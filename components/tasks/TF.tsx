...
export const TareasFinalizadasComponent = ({ tasks }: TareasFinalizadasProps) => {
  ...
  return (
    <Card className="flex h-full w-[90vw] shrink-0 snap-start flex-col rounded-none border-4 border-r-4 lg:border-8 lg:border-r-8 lg:flex-1 lg:w-auto bg-green-50/50 dark:bg-green-950/50 py-0">
