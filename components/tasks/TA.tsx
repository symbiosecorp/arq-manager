...
export const TareasAsignadasComponent = ({ tasks }: TareasAsignadasProps) => {
  ...
  return (
    <Card className="flex h-full w-[90vw] shrink-0 snap-start flex-col rounded-none border-4 border-r-4 lg:border-8 lg:border-r-8 lg:flex-1 lg:w-auto bg-blue-50/50 dark:bg-blue-950/50 py-0">
